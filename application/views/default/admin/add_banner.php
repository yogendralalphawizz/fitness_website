										...
										<form id="add_slider" method="post" style="max-width: 700px; margin: 0 auto;" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														<label>Link</label>
														<input type="text" required name="link" class="form-control" placeholder="Enter Link" />
													</div>
												</div>
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														<label>Priority</label>
														<input type="number" min="0" step="1" required name="priority" class="form-control" placeholder="Enter Priority" />
													</div>
												</div>
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
                                                    ...
                                                    <label>Banner Description</label>
														...
														<textarea id="banner_desc"  name="desc" class="form-control ckeditor" placeholder="Enter banner Description"></textarea>
														...
														<div>
															<div class="x-dropzone">
																...
																<div class="input-group" xrole="input-container">
																	<input name="image" type="file" xrole="input" class="form-control" accept=".jpeg,.jpg,.png,.gif" required>
