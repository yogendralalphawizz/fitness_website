											...
											<div class="row">
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														...
														<input type="text" required name="title" class="form-control" placeholder="Slider title" value="<?php echo addslashes($slider['title']); ?>" />
													</div>
												</div>
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														<label>Slider tagline</label>
														<input type="text" required name="tagline" class="form-control" placeholder="Enter tagline" value="<?php echo addslashes($slider['tagline']); ?>" />
													</div>
												</div>
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														<label>Button text</label>
														<input type="text" name="btn_text" required class="form-control"  placeholder="Enter button text" value="<?php echo addslashes($slider['btn_text']); ?>" />
													</div>
												</div>
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														<label>Button link</label>
														<input type="text" name="btn_link" required  class="form-control" placeholder="Enter target link" value="<?php echo addslashes($slider['btn_link']); ?>" />
													</div>
												</div>
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
