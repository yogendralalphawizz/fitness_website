...
<head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<?php echo BACKEND_CSS_URL; ?>images/favicon.ico">
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index-2.html" class="d-block auth-logo">
                                            <img src="assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">Login</span>
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        ...
                                        <form class="mt-4 pt-2" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="password" class="form-control" id="username" placeholder="New Password" name="new_pass">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Confirm Password</label>
                                                <input type="password" class="form-control" id="username" placeholder="Confirm Password" name="confirm_pass">
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Password Remembered? <a href="<?php echo base_url('/admin/Auth/login'); ?>"
...
<!-- Mirrored from themesbrand.com/minia/layouts/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Nov 2021 11:56:07 GMT -->
</html>