...
<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
              <form id="personal-info" method="post" style="max-width:700px;     margin: 0 auto;" action="<?=base_url()?>admin/Dashboard/insert_category" enctype="multipart/form-data">
          ...
          <div class="row col-lg-11 col-sm-12 form_layout_changer">
              ...
              <div class="col-lg-12 col-md-12 col-sm-10 col-sm-1">
                ...
                <div class="form-group row input-field">
                  ...
                  <div class="col-sm-12">
                    <input type="text" class="form-control" value="" id="input-1" placeholder="Category Name" name="category_name" required="">
                  </div>
                </div>
               ...
               <div class="col-xl-12 col-md-12">
                ...
                <div class="form-group row input-field">
                  ...
                  <div class="col-sm-12">
                    <input type="number" class="form-control" value="" id="input-sort" name="sort_order">
                  </div>
                </div>
                   <div class="input-field">
                <div class="form-group input-selectfield">
                ...
                <div class="form-group row input-field">
                  ...
                  <div class="col-sm-12">
                    <textarea class="form-control" id="input-des" name="description"></textarea>
                  </div>
                 </div> 
                 ...
                 <div class="form-group row input-field">
                  ...
                  <div class="col-sm-12">
                    <input type="text" class="form-control" value="" id="meta_category" name="meta_keyword" >
                  </div>
                </div>
                 <div class="form-group row input-field">
