							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header groupformheader">
										...
										<a href="<?=base_url('admin/Dashboard/add_size')?>">	
									<button type="button" class="btn btn-success waves-effect btn-label waves-light"><i class="bx bx-plus label-icon"></i> Add Size</button>
									</a>
									</div>
									<div class="card-body">
...
window.addEventListener('load', function(){
	$('#social_slider_table').DataTable({
		"processing": true,
		"serverSide": true,
		"ajax": "<?php echo base_url('admin/Dashboard/sizes_datatable'); ?>",
		"columns": [
			{ "data": 'name' },
			{ "data": 'status' },
