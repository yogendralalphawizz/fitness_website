								...
								<div class="page-title-box d-sm-flex align-items-center justify-content-between">
									...
									<div class="page-title-right">
										<ol class="breadcrumb m-0">
											...
											<li class="breadcrumb-item active">Edit App Page </li>
										</ol>
									</div>
											...
											<div class="row">
												...
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														...
														<input type="text" required name="short_descr" class="form-control" placeholder="Short Description"  value="<?php echo addslashes($slider['short_descr']); ?>"/>
													</div>
												</div>
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														<label>Long Description</label>
														<textarea required id="page_long_descr" name="long_descr" class="form-control ckeditor" placeholder="Enter Long Description"><?php echo addslashes($slider['long_descr']); ?></textarea>
