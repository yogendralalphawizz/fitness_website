											...
											<div class="row">
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														...
														<input type="text" required name="question" class="form-control" placeholder="Enter Question" value="<?php echo addslashes($slider['question']); ?>" />
													</div>
												</div>
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														<label>Answer</label>
														<textarea required name="answer" class="form-control" placeholder="Enter Answer"><?php echo addslashes($slider['answer']); ?></textarea>
													</div>
												</div>
												<div class="col-xl-12 col-md-12">
													<div class="form-group mb-3">
														<label>Priority</label>
														<input type="number" class="form-control" name="priority" step="1" min="0" placeholder="Enter Priority" value="<?php echo addslashes($slider['priority']); ?>">
													</div>
												</div>
											</div>                                                
