...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="margin:0px; padding:0px;" bgcolor="#ffffff">
     ...
     <?php
     $project_id=$message;
     $project_details=$this->db->get_where('project',['id'=>$project_id])->row_array();
     $posted_by=$project_details['user_id'];
     $project_owner_details=$this->db->get_where('users',['id'=>$posted_by])->row_array();
      ...
      <tr>
        <td align="center" valign="top"  bgcolor="#ffffff">
          <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
            ...
            <tr>
              <td align="center"><a href="#" target="_blank" style="text-decoration:none;"><img src="<?=base_url('assets/frontend/images/logo/odddevelopers.png')?><?=get_settings()?>" width="230" height="80" style="display:block;font-family: Arial, sans-serif; font-size:15px; line-height:18px; color:#30373b;  font-weight:bold;" border="0" alt="LoGo Here" /></a></td>
            </tr>
            <tr>
