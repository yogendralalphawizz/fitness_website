...
class Email_model extends CI_Model {
	...
	public function send_email_verification_mail($to = "", $verification_code = "") {
		...
		$from		=	$this->db->get_where('settings' , array('key_name' => 'system_email'))->row()->key_value;

		//SMTP & mail configuration
		$config = array(
			'protocol'  => 'smtp',
			'smtp_crypto' => 'ssl',
			'smtp_host' => 'mail.digivizcard.com',
			'smtp_port' => '465',
			'smtp_user' => 'info@digivizcard.com',
			'smtp_pass' => 'S)B102lv@vTV',
			'mailtype'  => 'html',
			'charset'   => 'iso-8859-1'
		);
		...
		$email_data = array('subject' => $subject, 'message' => $email_msg);
